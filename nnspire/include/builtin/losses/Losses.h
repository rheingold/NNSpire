/* ============================================================================
 * Losses.h — built-in loss functions  [NNSpire::builtin::losses]
 * LGPL v3
 *
 * All concrete loss classes inherit from NNSpire::ILoss (Tier 1 interface).
 * The interface is defined in <NNSpire/ILoss.h>.
 *
