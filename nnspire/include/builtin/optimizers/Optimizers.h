/* ============================================================================
 * Optimizers.h — SGD, Adam, AdamW + StepDecayScheduler  [NNSpire::builtin::optimizers]
 * LGPL v3
 *
 * All concrete optimizer classes inherit from NNSpire::IOptimizer (Tier 1).
 * The interface (incl. zeroGrad and ILRScheduler) is in <NNSpire/IOptimizer.h>.
 *
