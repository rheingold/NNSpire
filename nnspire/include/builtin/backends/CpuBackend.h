/* ============================================================================ 
 * CpuBackend.h — Eigen-based CPU compute backend  [NNSpire::builtin::backends]
 * LGPL v3
 *
 * CpuBackend is NNSpire's own implementation of IBackend.
 * It lives in NNSpire::builtin::backends:: and is treated identically to any
 ...
 *
 * Then anywhere in the codebase:  B()  (NNSpire::backend() free fn)
