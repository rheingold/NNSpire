# NNSpire Python Layer Plugin Scaffold

This scaffold generates a Python wheel that implements a custom NNSpire
layer plugin.

## Prerequisites

- Python 3.10+
- NNSpire Python bridge (`pip install NNSpire`)
...
6. **Install** — copy the wheel, `plugin.manifest.json`, and `.p7s` to:
   ...
   Then `pip install` the wheel in the NNSpire Python environment.
