"""
{{PLUGIN_NAME}} — NNSpire Layer Plugin (Python)
...
from NNSpire import Tensor


class {{PLUGIN_CLASS_NAME}}:
    """
    {{PLUGIN_NAME}} — custom NNSpire layer plugin.
    ...
    def __init__(self) -> None:
        ...
        # Example:
        #   import NNSpire
        #   self.weight = NNSpire.Parameter(shape=[input_size, output_size])
        #   self.bias   = NNSpire.Parameter(shape=[output_size])
        pass
