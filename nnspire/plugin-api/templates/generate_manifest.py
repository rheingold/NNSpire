#!/usr/bin/env python3
"""
generate_manifest.py — NNSpire Plugin Manifest Generator
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Generate or update an NNSpire plugin.manifest.json",
    ...
    print("  3. NNSpire-sign sign --manifest", args.out, "--cert plugin.crt --key plugin.key")
