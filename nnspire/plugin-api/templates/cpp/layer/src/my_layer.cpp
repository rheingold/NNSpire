/* ============================================================================
 * {{PLUGIN_NAME}} — NNSpire Layer Plugin implementation
 *
...
static const NNPluginDescriptor DESCRIPTOR = {
    /* api_version */ NNSpire_PLUGIN_API_VERSION,
...
extern "C" const NNPluginDescriptor* NNSpire_plugin_descriptor() noexcept {
    return &DESCRIPTOR;
}
