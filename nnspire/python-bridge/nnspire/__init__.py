"""
NNSpire — NNSpire Python package.
...
For a true drop-in replacement of torch.nn in scripts:
    ...
    import NNSpire as torch            # ← swap this from 'import torch'
    import NNSpire.nn as nn
    import NNSpire.nn.functional as F
    import NNSpire.optim as optim
...
# When installed this __init__.py sits alongside NNSpire.<ext>.so/.pyd.
#
# Windows / MinGW note
# --------------------
...
# must call `os.add_dll_directory(...)` before importing NNSpire, or copy
...
from .NNSpire import *          # noqa: F401, F403  — re-export compiled bindings
from .NNSpire import __version__  # noqa: F401
