/* ============================================================================
 * nnstudio_plugin.h  —  NNStudio Plugin ABI  —  LGPL v3
 *
 * PUBLIC API — C linkage only (no C++ in this header).
 *
 * Every NNStudio plugin shared library / Python module must expose the symbol
 ...
 * VERSIONING
 * ──────────
 *   api_version in NNPluginDescriptor must equal NNSTUDIO_PLUGIN_API_VERSION.
...
/* ─── Descriptor ──────────────────────────────────────────────────────────── */
/**
 * Statically returned by nnstudio_plugin_descriptor().
...
/**
 * nnstudio_plugin_descriptor — mandatory export
 *
...
/**
 * Inference-runner connector (e.g. connects to nnstudio-runner sidecar,
