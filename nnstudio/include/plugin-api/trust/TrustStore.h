 ...
 * TRUST MODEL (Phase 2)
 * ──────────────────────
 * NNStudio uses a multi-level trust hierarchy for plugins:
 *
 ...
 * embedded in the binary and verified by the nnstudio-sign tool at build time.
 *
...
enum class TrustLevel : uint32_t {
    ...
    Root       = 3,  ///< signed directly by the embedded root CA (nnstudio core)
};
 ...
 *   // ... use verifier ...
 *   store.save("/etc/nnstudio/trust.nnts");
 *
...
public:
     ...
     *  This is the factory used by NNStudio at startup. */
