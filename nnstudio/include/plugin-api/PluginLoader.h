 ...
 * ────────────────────────────
 * Phase 5 will run plugins in a separate process (nnstudio-runner sidecar)
...
public:
    ...
    const nnstudio::trust::VerifyResult& trustInfo() const noexcept { return trust_; }
...
private:
    ...
    nnstudio::trust::VerifyResult    trust_;
    std::string                      path_;
...
// ─── PluginLoader ─────────────────────────────────────────────────────────────
/**
 * Loads and verifies NNStudio plugins.
 *
 * Usage:
