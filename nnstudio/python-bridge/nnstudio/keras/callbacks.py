"""
nnstudio.keras.callbacks — Keras-compatible training callbacks.
...
Usage::
    ...
    from nnstudio.keras.callbacks import EarlyStopping, ModelCheckpoint
...
class ModelCheckpoint(Callback):
    ...
    actual binary I/O (via ``nnstudio.core.Checkpoint``) is wired in a
